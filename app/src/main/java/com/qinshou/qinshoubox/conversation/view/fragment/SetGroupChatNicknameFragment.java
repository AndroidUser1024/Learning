 ...
 */
public class SetGroupChatNicknameFragment extends QSFragment<SetGroupChatNicknamePresenter> implements ISetGroupChatNameContract.IView {
    ...
    public static void start(Context context, String groupChatId, String nickname) {
        ...
        context.startActivity(ContainerActivity.getJumpIntent(context, SetGroupChatNicknameFragment
                .class, bundle));
    }
