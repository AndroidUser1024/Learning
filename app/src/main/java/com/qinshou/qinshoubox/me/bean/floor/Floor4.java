...
//        row0.add(new CaseBean(IMonster.QING_TOU_GUAI, R.drawable.magic_tower_monster_qing_tou_guai));
//        row0.add(new CaseBean(Building.ROAD, R.drawable.magic_tower_building_road));
...
//        row3.add(new CaseBean(IMonster.HONG_BIAN_FU, R.drawable.magic_tower_monster_hong_bian_fu));
//        row3.add(new CaseBean(IMonster.DA_BIAN_FU, R.drawable.magic_tower_monster_da_bian_fu));
//        row3.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row3.add(new CaseBean(IMonster.KU_LOU_REN, R.drawable.magic_tower_monster_ku_lou_ren));
//        row3.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row4.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
//        row4.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row6.add(new CaseBean(IMonster.HONG_TOU_GUAI, R.drawable.magic_tower_monster_hong_tou_guai));
...
//        row6.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row6.add(new CaseBean(IMonster.SHOU_MIAN_REN, R.drawable.magic_tower_monster_shou_mian_ren));
//        row6.add(new CaseBean(IMonster.CHU_JI_WEI_BING, R.drawable.magic_tower_monster_chu_ji_wei_bing));
//        row6.add(new CaseBean(IMonster.SHOU_MIAN_REN, R.drawable.magic_tower_monster_shou_mian_ren));
//        row6.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row6.add(new CaseBean(Building.ROAD, R.drawable.magic_tower_building_road));
//        row6.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row10.add(new CaseBean(IMonster.QING_TOU_GUAI, R.drawable.magic_tower_monster_qing_tou_guai));
//        row10.add(new CaseBean(Building.ROAD, R.drawable.magic_tower_building_road));
//        row10.add(new CaseBean(Building.ROAD, R.drawable.magic_tower_building_road));
//        row10.add(new CaseBean(Building.ROAD, R.drawable.magic_tower_building_road));
//        row10.add(new CaseBean(IMonster.QING_TOU_GUAI, R.drawable.magic_tower_monster_qing_tou_guai));
