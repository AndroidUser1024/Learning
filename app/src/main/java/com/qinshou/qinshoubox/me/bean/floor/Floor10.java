...
public class Floor10 extends AbsFloor {
    ...
    public List<List<CaseBean>> setData() {
        ...
        row2.add(new CaseBean(Prop.XIE_PING_BIG, R.drawable.magic_tower_prop_xie_ping_big));
        floor10.add(row2);
        ...
        row9.add(new CaseBean(Prop.BAO_SHI_RED, R.drawable.magic_tower_prop_bao_shi_red));
        ...
        row10.add(new CaseBean(Prop.BAO_SHI_BLUE, R.drawable.magic_tower_prop_bao_shi_blue));
