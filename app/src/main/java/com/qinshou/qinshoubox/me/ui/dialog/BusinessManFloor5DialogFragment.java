...
//
//        View rootView = inflater.inflate(R.layout.dialog_business_man_floor_5, null);
...
//                        WarriorBean.getInstance().buyYellowKeyWith10Money();
//                        break;
//                    case R.id.radio_button_2:
//                        WarriorBean.getInstance().buyBlueKeyWith50Money();
//                        break;
//                    case R.id.radio_button_3:
//                        WarriorBean.getInstance().buyKeyRedWith100Money();
//                        break;
