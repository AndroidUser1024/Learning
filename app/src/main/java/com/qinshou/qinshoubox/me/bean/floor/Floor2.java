...
//        row1.add(new CaseBean(IProp.BAO_SHI_BLUE, R.drawable.magic_tower_prop_gem_blue));
//        row1.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row2.add(new CaseBean(IProp.KEY_YELLOW, R.drawable.magic_tower_prop_key_yellow));
//        row2.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row2.add(new CaseBean(IProp.BAO_SHI_RED, R.drawable.magic_tower_prop_gem_red));
//        row2.add(new CaseBean(IProp.BAO_SHI_BLUE, R.drawable.magic_tower_prop_gem_blue));
//        row2.add(new CaseBean(IProp.KEY_YELLOW, R.drawable.magic_tower_prop_key_yellow));
//        row2.add(new CaseBean(IMonster.JIN_WEI_SHI, R.drawable.magic_tower_monster_jin_wei_shi));
//        row2.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        floor2.add(row2);
//
...
//        row8.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row8.add(new CaseBean(IProp.XIE_PING_BIG, R.drawable.magic_tower_prop_blood_bottle_big));
