...
//        row2.add(new CaseBean(IProp.BAO_SHI_BLUE, R.drawable.magic_tower_prop_gem_blue));
...
//        row3.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
...
//        row4.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
...
//        row5.add(new CaseBean(IProp.KEY_RED, R.drawable.magic_tower_prop_key_red));
...
//        row6.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
...
//        row7.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
//        row7.add(new CaseBean(Building.STARRY_SKY, R.drawable.magic_tower_building_starry_sky));
//        row7.add(new CaseBean(IProp.KEY_YELLOW, R.drawable.magic_tower_prop_key_yellow));
//        row7.add(new CaseBean(Building.STARRY_SKY, R.drawable.magic_tower_building_starry_sky));
...
//        row9.add(new CaseBean(Building.STARRY_SKY, R.drawable.magic_tower_building_starry_sky));
//        row9.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
//        row9.add(new CaseBean(Building.STARRY_SKY, R.drawable.magic_tower_building_starry_sky));
//        row9.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
//        row9.add(new CaseBean(Building.STARRY_SKY, R.drawable.magic_tower_building_starry_sky));
//        row9.add(new CaseBean(IProp.KEY_YELLOW, R.drawable.magic_tower_prop_key_yellow));
...
//        row10.add(new CaseBean(IProp.KEY_RED, R.drawable.magic_tower_prop_key_red));
//        row10.add(new CaseBean(IMonster.MING_DUI_ZHANG_2, R.drawable.magic_tower_monster_ming_dui_zhang));
//        row10.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
//        row10.add(new CaseBean(IMonster.BAI_YI_WU_SHI, R.drawable.magic_tower_monster_bai_yi_wu_shi));
//        row10.add(new CaseBean(IProp.BAO_SHI_RED, R.drawable.magic_tower_prop_gem_red));
