...
//        row0.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row0.add(new CaseBean(Prop.XIE_PING_BIG, R.drawable.magic_tower_prop_blood_bottle_big));
//        row0.add(new CaseBean(Prop.HUANG_JIN_DUN, R.drawable.magic_tower_prop_huang_jin_dun));
//        row0.add(new CaseBean(Prop.XIE_PING_BIG, R.drawable.magic_tower_prop_blood_bottle_big));
//        floor11.add(row0);
//
//        List<CaseBean> row1 = new ArrayList<>();
//        row1.add(new CaseBean(Prop.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
...
//        row2.add(new CaseBean(Prop.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
...
//        row6.add(new CaseBean(Prop.XIE_PING_BIG, R.drawable.magic_tower_prop_blood_bottle_big));
