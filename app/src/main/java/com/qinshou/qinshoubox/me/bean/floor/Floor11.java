...
//        row0.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
...
//        row0.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row0.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
//        row0.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row0.add(new CaseBean(IProp.KEY_RED, R.drawable.magic_tower_prop_key_red));
//        row0.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row1.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
...
//        row1.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row1.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
//        row1.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row1.add(new CaseBean(IProp.KEY_RED, R.drawable.magic_tower_prop_key_red));
//        row1.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row2.add(new CaseBean(IProp.XIE_PING_SMALL, R.drawable.magic_tower_prop_blood_bottle_small));
...
//        row2.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row2.add(new CaseBean(IProp.KEY_BLUE, R.drawable.magic_tower_prop_key_blue));
//        row2.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row2.add(new CaseBean(IProp.KEY_RED, R.drawable.magic_tower_prop_key_red));
//        row2.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
...
//        row6.add(new CaseBean(IProp.XIE_PING_BIG, R.drawable.magic_tower_prop_blood_bottle_big));
...
//        row7.add(new CaseBean(IMonster.SHOU_MIAN_WU_SHI, R.drawable.magic_tower_monster_shou_mian_wu_shi));
//        row7.add(new CaseBean(Building.WALL, R.drawable.magic_tower_building_wall));
//        row7.add(new CaseBean(IProp.BAO_SHI_RED, R.drawable.magic_tower_prop_gem_red));
//        floor11.add(row7);
//
