 ...
 * Description:新闻模块的接口
 */
@Api(IUrlConstant.DEFAULT_HOST_ONLINE + IUrlConstant.NEWS_API)
public interface QSBoxNewsApi {
    @Get("/getList")
    Call<QinshouResultBean<List<NewsBean>>> getList(@Query(name = "page") int page, @Query(name = "pageSize") int pageSize);
}
