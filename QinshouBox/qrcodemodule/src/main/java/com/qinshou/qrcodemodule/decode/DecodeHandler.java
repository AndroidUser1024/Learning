...
package com.qinshou.qrcodemodule.decode;
...
public final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = mCaptureView.getCameraManager()
        ...
        CaptureHandler handler = mCaptureView.getCaptureHandler();
        if (rawResult != null) {
            if (handler != null) {
