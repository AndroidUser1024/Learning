...
public class BattleDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        WarriorBean warrior = WarriorBean.getInstance();
        ...
        //设置勇士信息
        mTvWarriorLifeValue.setText("生命:" + warrior.getLifeValue());
        mTvWarriorAttackValue.setText("攻击:" + warrior.getAttackValue());
        mTvWarriorDefenseValue.setText("防御:" + warrior.getDefenseValue());

        new BattleThread(monster, warrior).start();
        return rootView;
    }
    ...
    private class BattleThread extends Thread {
        ...
        public void run() {
            ...
            message.arg2 = mWarrior.getLifeValue() + warriorTotalLossLifeValue;
            mHandler.sendMessage(message);
            for (int i = 0; i <= bout; i++) {
                ...
                message.arg2 = mWarrior.getLifeValue() - i * warriorEachBoutLossLifeValue + warriorTotalLossLifeValue;
                mHandler.sendMessage(message);
                SystemClock.sleep(200);
            }
            message = Message.obtain();
