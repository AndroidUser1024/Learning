...
public class PcmToWavUtil {
     ...
     */
    public static void transformPcm2Wav(final File pcmFile, final File wavFile, final int sampleRate, final int channels, final int bitNum, final boolean deletePcmFile, final IOnTransformCallback onTransformCallback) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    writeWaveFileHeader(fileOutputStream, totalAudioLen, totalDataLen, sampleRate, channels, byteRate);
                    ...
                    if (onTransformCallback != null) {
                        onTransformCallback.onSuccess(wavFile);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                } finally {
    ...
    public interface IOnTransformCallback {
